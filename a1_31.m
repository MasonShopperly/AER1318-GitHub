...
clear; clc;
[gamma, R, T01, p01, S_star] = defineConstants();
[j, x] = generateGrid();
S = defineAreaFunction();
M = solveMachDistribution(gamma, S, S_star, x);
[T, p] = calculateDistributions(M, gamma, T01, p01);
plotResults(x, M, p);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Supporting functions
function [gamma, R, T01, p01, S_star] = defineConstants()
...
function [f, df] = areaMachFunction(M, gamma, Sx, S_star)
...
function M = solveMachDistribution(gamma, S, S_star, x)
...
function [T, p] = calculateDistributions(M, gamma, T01, p01)
